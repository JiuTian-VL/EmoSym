...
class Qwen2VLEmo(Qwen2VLForConditionalGeneration):
    def __init__(self, config, context=False, joint_train=False, training_context=False):
        ...
        if training_context:
            self.text_encoder = CLIPTextModel.from_pretrained('/zhu_yi_jie/Zyj_MM/model/clip-vit-large-patch14')
            self.clip_tokenizer = CLIPTokenizer.from_pretrained('/zhu_yi_jie/Zyj_MM/model/clip-vit-large-patch14')
