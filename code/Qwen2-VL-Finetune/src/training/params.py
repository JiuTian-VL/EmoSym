...
class ModelArguments:
    ...
    clip_path: Optional[str] = field(default="OpenAI/clip-vit-large-patch14-336")
    rf_model_path: Optional[str] = field(default="Qwen/Qwen2-VL-7B-Instruct")
    rf_model_base: Optional[str] = field(default="Qwen/Qwen2-VL-7B-Instruct")
