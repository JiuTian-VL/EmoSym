...
def load_model(args):
    ...
    if 'lora' in args.model_path.lower() and args.model_base is not None:
        ...
        model = Qwen2VLForConditionalGeneration.from_pretrained(args.model_base, low_cpu_mem_usage=True, context=args.context, joint_train=args.joint_train, **kwargs)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default='/zhu_yi_jie/Zyj_MM/Training_EMO/EmoSet_aug_lora_context_equal_1_FI_7B/checkpoint-2217')
    parser.add_argument("--model-base", type=str, default="/zhu_yi_jie/Zyj_MM/Qwen2-VL-7B-Instruct")
